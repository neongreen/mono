...
- Mix old and new in same diagram
...
```tsx
// Before
<Text fontSize={32} fontWeight="bold">My Diagram</Text>

// After
<Title level={1}>My Diagram</Title>
```

### Step 2: Replace styled boxes
```tsx
// Before
<Box backgroundColor="#e3f2fd" borderColor="#1976d2" borderWidth={2} borderRadius={8} padding={20}>
...
<Card variant="primary">
  <Stack gap={6}>
    <Label bold>Main Text</Label>
    <Subtitle>Secondary info</Subtitle>
  </Stack>
</Card>
```
