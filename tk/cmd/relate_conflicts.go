...
var relateConflictsCmd = &cobra.Command{
	Use:   "relate-conflicts [task-id]",
...
Otherwise, shows all conflicts in the database.`,
	RunE: conflictsCmdImpl,
}

var conflictsCmd = &cobra.Command{
	Use:   "conflicts [task-id]",
	Short: "Show relation conflicts (alias for relate-conflicts)",
	RunE:  conflictsCmdImpl,
}

func conflictsCmdImpl(cmd *cobra.Command, args []string) error {
...
func init() {
	relateConflictsCmd.Flags().Bool("json", false, "Output as JSON")
