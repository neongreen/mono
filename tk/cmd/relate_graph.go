...
var relateGraphCmd = &cobra.Command{
	Use:   "relate-graph [task-id]",
...
var graphCmd = &cobra.Command{
	Use:   "graph [task-id]",
	Short: "Show a graph of task relations (alias for relate-graph)",
	Args:  cobra.ExactArgs(1),
	RunE:  graphCmdImpl,
}

func graphCmdImpl(cmd *cobra.Command, args []string) error {
	taskRef := args[0]
