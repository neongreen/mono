...
//   - Synthetic projects use the literal corrupt value as project_uid (e.g., "lovable")
...
// (e.g., to_project_uid="lovable" instead of "prj_..."), tasks became orphaned when
...
// "lovable" projects at different times), corrupt events referencing both will
