...
func (r *Reducer) Apply(e types.Event) error {
	...
	// Handle shared events (status, notes, relations, delete, metadata)
        ...
        case "task.status.set":
                //lion:event.task.status.set section="task.status.set"
        ...
        case "task.note.add":
                //lion:event.task.note.add section="task.note.add"
        ...
        case "task.delete":
                //lion:event.task.delete section="task.delete"
        ...
        case "task.meta.set":
                //lion:event.task.meta.set section="task.meta.set"
        ...
        case "relation.add":
                //lion:event.relation.add section="relation.add"
        ...
        case "relation.remove":
                //lion:event.relation.remove section="relation.remove"
        ...
        case "relation.note":
                //lion:event.relation.note section="relation.note"
        ...
        case "task.attachment.add":
                //lion:event.task.attachment.add section="task.attachment.add"
        ...
        case "task.attachment.remove":
                //lion:event.task.attachment.remove section="task.attachment.remove"
